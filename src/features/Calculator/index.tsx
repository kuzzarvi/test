...
export const Calculator: React.FC = memo(() => {
  ...
  const {
    ...
    services,
    setServices,
  } = useTariff(tariffConfig?.minutesMin, tariffConfig?.gigabytesMin);
  ...
  return (
    <div className="tariff-calculator-container">
      ...
      <div className="sliders-group">
        <Slider
          step={tariffConfig.minutesStep}
          min={tariffConfig.minutesMin}
          max={tariffConfig.minutesMax}
          value={minutes}
          onChange={setMinutes}
          unit={"мин"}
          label={"Минуты на другие номера"}
        />
        <Slider
          step={tariffConfig.gigabytesStep}
          min={tariffConfig.gigabytesMin}
          max={tariffConfig.gigabytesMax}
          value={gigabytes}
          onChange={setGigabytes}
          unit={"ГБ"}
